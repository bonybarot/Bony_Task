...
const FavouritesTab = () => {
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const favoriteEvents = allEvents.filter(event => event.isFavorite);
    ...
    <View style={styles.container}>
      ...
      {events.length === 0 ? (
        <View style={styles.noDataContainer}>
          <Text style={styles.noDataText}>No Favourites Found</Text>
        </View>
      ) : (
        <FlatList
          data={events}
              ...
              <View style={styles.eventDetails}>
                ...
                <View style={styles.actionsContainer}>
                  ...
                  <View style={styles.iconContainer}>
                    ...
                    <AntDesign name={'heart'} size={moderateScale(30)} />
                  </View>
                </View>
              </View>
            </View>
